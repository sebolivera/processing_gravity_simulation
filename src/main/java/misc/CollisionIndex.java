...
public final class CollisionIndex {
     ...
     */
    private static Map.Entry<Integer, Integer>key(int sphere1, int sphere2) {
     ...
     */
    public static boolean tryLock(int sphere1, int sphere2) {
     ...
     */
    public static void unlock(int sphere1, int sphere2) {
