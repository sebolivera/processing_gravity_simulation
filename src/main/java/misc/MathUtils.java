...
public final class MathUtils extends PApplet {
    public static float getXYZAngleForImpactVector (PVector vel, PVector delta_vel) {
    ...
    public static PVector getCenterVector (PVector vect, PVector delta)//applies the angle to the original vector, which it gets from the normalized delta center-vector impact
    {
    ...
    public static PVector getNormalizedDelta(PVector pos_1, PVector pos_2)//gets the angle between two colliding spheres and normalizes it.
    {
    ...
    public static PVector getNormalVector(PVector vel, PVector pos_1, PVector pos_2) {//Takes two positions and a velocity, and sends back the opposite impact vector (impact vectors get transfered from the velocity of the other object).
    ...
    public static public static float easeOut(float a, float b, float f, float fac) {
        return lerp(a, b, (float) MathUtils.pow(1.0f-f, fac));
    }
}
