...
/**
 * Utility static class for mathematical operations. <i>Here's where I store my mathematical mops,
 * buckets, and bleach.</i>
 */
public final class MathUtils extends PApplet {
    ...
    /**
     * Represents a functional interface for operations that take a {@code Float} value and perform
     * an update or action with it. <i>A truly titanic function.</i>
     */
    ...
    /**
     * Gets xyz angle between the direction of an object and the vector between it and the other
     * ball. Note: PVector.angleBetween function gave odd results in processing 3. <i>Do you get my
     * angle?</i>
     *
    ...
    /**
     * Applies the angle between the direction of an object and the vector between it and the other
     * ball to the original vector. <i>Relax, find your center.</i>
     *
    ...
    /**
     * Gets the angle between two colliding spheres and normalizes it. <i>Other manners of rivers
     * joining the sea are to be considered abnormal.</i>
     *
    ...
    /**
     * Takes two positions and a velocity and sends back the opposite impact vector (impact vectors
     * get transferred from the velocity of the other object). <br>
     * <br>
     ...
     * @return The opposite impact vector, expressed in the direction of the other object's
     *     velocity.'
     */
